...
def test_sympy():
    ...
    process_sympy("e")
    print
    process_sympy("\\frac{dx}{dy} \\int y x^2 dy")
    print
    process_sympy("\\frac{dx}{dy} 5")
    print
    process_sympy("\\frac{d}{dx} \\int x^2 dx")
    print
    process_sympy("\\frac{dx}{dy} \\int x^2 dx")
    print
    process_sympy("\\frac{d}{dy} x^2 + x y = 0")
    print
    process_sympy("\\frac{d}{dy} x^2 + x y = 2")
    print
    process_sympy("\\frac{d x^3}{dy}")
    print
    process_sympy("\\frac{d x^3}{dy} + x^3")
    print
    process_sympy("\\int^{5x}_{2} x^2 dy")
    print
    process_sympy("\\int_{5x}^{2} x^2 dx")
    print
    process_sympy("\\int x^2 dx")
    print
    process_sympy("2 4 5 - 2 3 1")
